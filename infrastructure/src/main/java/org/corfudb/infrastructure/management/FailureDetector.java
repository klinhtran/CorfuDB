...
public class FailureDetector implements IDetector {
    ...
    PollReport pollRound(
        ...
        for (int iteration = 0; iteration < failureThreshold; iteration++) {
            ...
            Duration pollInterval = networkStretcher.modifyIterationTimeouts(currReport.getFailedNodes());
            ...
            Sleep.sleepUninterruptibly(pollInterval);
        }
    ...
    private void tunePollReportTimeouts(
        ...
        tuneRoutersResponseTimeout(
                clientRouters, allConnectedNodes, networkStretcher.getDecreasedPeriod()
        );
