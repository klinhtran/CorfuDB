...
public enum CorfuMsgType {
    ...
    MISSING_ADDRESS_REQUEST(86, new TypeToken<CorfuPayloadMsg<MissingAddressRequest>>() {}),
    MISSING_ADDRESS_RESPONSE(87, new TypeToken<CorfuPayloadMsg<MissingAddressResponse>>() {}),
